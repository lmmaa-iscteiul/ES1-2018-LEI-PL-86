...
public class Table_line {
	 ...
	 * <p>Each line contains a message, along with the message's type, sender, and source.
	 * @param message - a String with the actual message/content that the sender wanted to share.
	 * @param type - the type of message.
	 * @param sender - who sent the message.
	 * @param source - where the message was shared, or from where we got said message.
	 */
